...
import {
  ...
  Search, FileText, X, FilePen, Download,
  AtSign, ShieldAlert, UserX, Store, MapPin,
  Undo2,
} from 'lucide-react';
      ...
      <div className="flex gap-2 overflow-x-auto pb-1">
        {(['semua', 'pending', 'verified', 'rejected', 'withdrawn'] as StatusFilter[]).map(f => {
          ...
          const labels: Record<StatusFilter, string> = {
            semua: 'Semua', pending: 'Pending', verified: 'Verified', rejected: 'Rejected', withdrawn: 'Sedang Direvisi',
          };
          return (
            <button
              key={f}
                  ...
                  <div className="border-t border-slate-100 px-4 sm:px-5 py-5 bg-slate-50/60 space-y-5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                      {[
                        ...
                        report.store_name        ? { label: 'Nama Toko',    value: report.store_name,                                                             className: '' }                                                                       : null,
                        report.suspect_city      ? { label: 'Provinsi',     value: report.suspect_city,                                                           className: '' }                                                                       : null,
