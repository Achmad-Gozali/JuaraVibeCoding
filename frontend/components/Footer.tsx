...
const layananUtama = [
  ...
  { label: 'API Developer',  href: '/developer'    },
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 lg:gap-10 mb-12">
            ...
            <ul className="space-y-3">
              {layananUtama.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-xs font-bold text-slate-300 hover:text-emerald-400 uppercase tracking-wider transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <div className="flex md:flex-col gap-3">
              ...
              <a href="https://www.facebook.com/ali.gntng201" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2.5 text-xs font-bold text-slate-300 hover:text-white transition-colors">
                <span className="w-8 h-8 border border-slate-600 rounded-lg flex items-center justify-center hover:border-slate-400 transition-colors shrink-0">
